...
DROP TABLE IF EXISTS `datathon2023-team4.eicu_crd_pulseOx_us.pivoted_lab2`;
CREATE TABLE `datathon2023-team4.eicu_crd_pulseOx_us.pivoted_lab2` AS
...
(
  ...
  FROM `datathon2023-team4.eicu_crd_us.lab` AS lab
  where labname in
  (
      'albumin'
    , 'total bilirubin'
